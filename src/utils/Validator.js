 ...
 * for validation across the system with reduced boilerplate
 */
class Validator {
    /**
     ...
     * @throws {Error} If validation fails
     */
    static validateNonEmptyArray(value, name = 'Value') {
     ...
     * @throws {Error} If validation fails
     */
    static validateTask(value, name = 'Value') {
     ...
     * @throws {Error} If validation fails
     */
    static validateTerm(term, name = 'Term') {
     ...
     * @throws {Error} If validation fails
     */
    static validatePunctuation(punctuation, name = 'Punctuation') {
     ...
     * @throws {Error} If validation fails
     */
    static validateTruthValue(truthValue, name = 'TruthValue') {
     ...
     * @throws {Error} If validation fails
     */
    static validateWith(value, validator, errorMessage) {
