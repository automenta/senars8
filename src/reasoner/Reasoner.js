...
class Reasoner {
    ...
    _initializeStrategy(strategyName) {
        ...
        const StrategyClass = strategyMap[strategyName] || BagSamplingStrategy;
    ...
    performInference(focusSet, options = {}) {
        ...
        // Step 1: Perform symbolic inference
        ...
        // Step 2: If more tasks are needed, perform temporal inference
        let temporalTasks = [];
        ...
        // Step 3: Combine and truncate the results
