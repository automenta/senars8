    ...
    describe('Enhanced Strategy Selection', () => {
        ...
        it('should use LM service for strategy prediction when available', async () => {
            ...
            const applicableStrategies = [
                {
                    name: 'SimpleStrategy',
                    metadata: {description: 'Simple strategy', category: 'test'},
                    stats: {successRate: 0.7, averageTime: 10}
                },
                {
                    name: 'ComplexStrategy',
                    metadata: {description: 'Complex strategy', category: 'test'},
                    stats: {successRate: 0.6, averageTime: 20}
                }
            ];
