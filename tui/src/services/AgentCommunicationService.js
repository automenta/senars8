...
/**
 * Node.js specific Agent Communication Service for TUI
 * Extends the shared service with Node.js-specific WebSocket implementation
 */
class AgentCommunicationService extends EventEmitter {
  constructor(url = 'ws://localhost:8080') {
    super();
    
    // Use the common service functionality, but override WebSocket implementation
    this.url = url;
    this.ws = null;
  ...
  // Basic event system to match browser version
  on(event, callback) {
